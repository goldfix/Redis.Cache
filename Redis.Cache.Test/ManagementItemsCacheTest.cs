...
namespace Redis.Cache.Test
{
    ...
    public class ManagementItemsCacheTest
    {
        ...
        public void Add()
        {
            ...
            long result = m.Add<string>(k, "B", TimeSpan.Zero, TimeSpan.Zero);
        ...
        public void Get_String()
        {
            ...
            string result_2 = m.Get <string>(k);
            Assert.AreEqual<string>(result_2, "B");

            result_2 = m.Get<string>(k+"1");
        ...
        public void Get_DateTime()
        {
            ...
            long result = m.Add<DateTime>(k, dt, TimeSpan.Zero, TimeSpan.Zero);
            Assert.AreEqual<long>(result, 2);

            DateTime result_3 = m.Get<DateTime>(k);
            Assert.AreEqual<DateTime>(result_3, dt);

            DateTime result_4 = m.Get<DateTime>(k+"1");
        ...
        public void Test_TTL_SLI()
        {
            ...
            string k = Guid.NewGuid().ToString();
            long result = m.Add<string>(k, "TTL_1", new TimeSpan(0,0,5), TimeSpan.Zero);
            Assert.AreEqual<long>(result, 2);

            //Wait 2 sec.
            System.Threading.Thread.Sleep(2000);
            string result_1 = m.Get<String>(k);
        ...
        public void Test_TTL_ABS()
        {
            ...
            string k = Guid.NewGuid().ToString();
            long result = m.Add<string>(k, "TTL_1", TimeSpan.Zero, new TimeSpan(0, 0, 15));
            Assert.AreEqual<long>(result, 2);
        ...
        public void Test_TTL_SLI_ABS()
        {
            ...
            string k = Guid.NewGuid().ToString();
            long result = m.Add<string>(k, "TTL_1", new TimeSpan(0, 0, 5), new TimeSpan(0, 0, 10));
            Assert.AreEqual<long>(result, 2);
